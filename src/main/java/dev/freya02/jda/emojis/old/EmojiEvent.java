...
interface EmojiEvent {
	UnicodeEmoji JACK_O_LANTERN = new UnicodeEmojiImpl("🎃");
	
	UnicodeEmoji CHRISTMAS_TREE = new UnicodeEmojiImpl("🎄");
	
	UnicodeEmoji FIREWORKS = new UnicodeEmojiImpl("🎆");
	
	UnicodeEmoji SPARKLER = new UnicodeEmojiImpl("🎇");
	
	UnicodeEmoji FIRECRACKER = new UnicodeEmojiImpl("🧨");
	
	UnicodeEmoji SPARKLES = new UnicodeEmojiImpl("✨");
