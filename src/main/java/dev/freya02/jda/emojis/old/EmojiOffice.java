...
interface EmojiOffice {
	UnicodeEmoji BRIEFCASE = new UnicodeEmojiImpl("💼");
	
	UnicodeEmoji FILE_FOLDER = new UnicodeEmojiImpl("📁");
	...
	UnicodeEmoji CHART_WITH_UPWARDS_TREND = new UnicodeEmojiImpl("📈");
	
	UnicodeEmoji CHART_WITH_DOWNWARDS_TREND = new UnicodeEmojiImpl("📉");
	
	UnicodeEmoji BAR_CHART = new UnicodeEmojiImpl("📊");
	
	UnicodeEmoji CLIPBOARD = new UnicodeEmojiImpl("📋");
	
	UnicodeEmoji PUSHPIN = new UnicodeEmojiImpl("📌");
	
	UnicodeEmoji ROUND_PUSHPIN = new UnicodeEmojiImpl("📍");
	
	UnicodeEmoji PAPERCLIP = new UnicodeEmojiImpl("📎");
