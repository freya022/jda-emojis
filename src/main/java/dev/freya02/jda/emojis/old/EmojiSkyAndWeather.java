...
interface EmojiSkyAndWeather {
	UnicodeEmoji NEW_MOON = new UnicodeEmojiImpl("🌑");
	
	UnicodeEmoji WAXING_CRESCENT_MOON = new UnicodeEmojiImpl("🌒");
	
	UnicodeEmoji FIRST_QUARTER_MOON = new UnicodeEmojiImpl("🌓");
	
	UnicodeEmoji WAXING_GIBBOUS_MOON = new UnicodeEmojiImpl("🌔");
	
	UnicodeEmoji FULL_MOON = new UnicodeEmojiImpl("🌕");
	
	UnicodeEmoji WANING_GIBBOUS_MOON = new UnicodeEmojiImpl("🌖");
	
	UnicodeEmoji LAST_QUARTER_MOON = new UnicodeEmojiImpl("🌗");
	
	UnicodeEmoji WANING_CRESCENT_MOON = new UnicodeEmojiImpl("🌘");
	...
	UnicodeEmoji RINGED_PLANET = new UnicodeEmojiImpl("🪐");
	...
	UnicodeEmoji RAINBOW = new UnicodeEmojiImpl("🌈");
	...
	UnicodeEmoji FIRE = new UnicodeEmojiImpl("🔥");
