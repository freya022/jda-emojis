...
interface EmojiArrow {
	...
	UnicodeEmoji ARROW_LOWER_RIGHT = new UnicodeEmojiImpl("↘️");
	...
	UnicodeEmoji LEFT_RIGHT_ARROW = new UnicodeEmojiImpl("↔️");
	
	UnicodeEmoji LEFTWARDS_ARROW_WITH_HOOK = new UnicodeEmojiImpl("↩️");
	
	UnicodeEmoji ARROW_RIGHT_HOOK = new UnicodeEmojiImpl("↪️");
	
	UnicodeEmoji ARROW_HEADING_UP = new UnicodeEmojiImpl("⤴️");
	
	UnicodeEmoji ARROW_HEADING_DOWN = new UnicodeEmojiImpl("⤵️");
	
	UnicodeEmoji ARROWS_CLOCKWISE = new UnicodeEmojiImpl("🔃");
	
	UnicodeEmoji ARROWS_COUNTERCLOCKWISE = new UnicodeEmojiImpl("🔄");
