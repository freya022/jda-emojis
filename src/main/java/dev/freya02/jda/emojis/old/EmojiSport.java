...
interface EmojiSport {
	...
	UnicodeEmoji SOFTBALL = new UnicodeEmojiImpl("🥎");
	
	UnicodeEmoji BASKETBALL = new UnicodeEmojiImpl("🏀");
	...
	UnicodeEmoji TENNIS = new UnicodeEmojiImpl("🎾");
	
	UnicodeEmoji FLYING_DISC = new UnicodeEmojiImpl("🥏");
	
	UnicodeEmoji BOWLING = new UnicodeEmojiImpl("🎳");
	
	UnicodeEmoji CRICKET_GAME = new UnicodeEmojiImpl("🏏");
	...
	UnicodeEmoji PING_PONG = new UnicodeEmojiImpl("🏓");
	
	UnicodeEmoji BADMINTON = new UnicodeEmojiImpl("🏸");
	
	UnicodeEmoji BOXING_GLOVE = new UnicodeEmojiImpl("🥊");
	...
	UnicodeEmoji CURLING_STONE = new UnicodeEmojiImpl("🥌");
