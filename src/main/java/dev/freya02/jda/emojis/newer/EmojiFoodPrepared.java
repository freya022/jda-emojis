...
interface EmojiFoodPrepared {
	UnicodeEmoji BREAD = new UnicodeEmojiImpl("🍞");
	...
	UnicodeEmoji PRETZEL = new UnicodeEmojiImpl("🥨");
	
	UnicodeEmoji BAGEL = new UnicodeEmojiImpl("🥯");
	...
	UnicodeEmoji MEAT_ON_BONE = new UnicodeEmojiImpl("🍖");
	
	UnicodeEmoji POULTRY_LEG = new UnicodeEmojiImpl("🍗");
	
	UnicodeEmoji CUT_OF_MEAT = new UnicodeEmojiImpl("🥩");
	
	UnicodeEmoji BACON = new UnicodeEmojiImpl("🥓");
	...
	UnicodeEmoji SANDWICH = new UnicodeEmojiImpl("🥪");
	
	UnicodeEmoji TACO = new UnicodeEmojiImpl("🌮");
	
	UnicodeEmoji BURRITO = new UnicodeEmojiImpl("🌯");
	...
	UnicodeEmoji EGG = new UnicodeEmojiImpl("🥚");
	...
	UnicodeEmoji BUTTER = new UnicodeEmojiImpl("🧈");
	
	UnicodeEmoji SALT = new UnicodeEmojiImpl("🧂");
	
	UnicodeEmoji CANNED_FOOD = new UnicodeEmojiImpl("🥫");
