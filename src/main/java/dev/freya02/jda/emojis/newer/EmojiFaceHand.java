...
interface EmojiFaceHand {
	...
	UnicodeEmoji HUGGING_FACE = new UnicodeEmojiImpl("🤗");
	
	UnicodeEmoji FACE_WITH_HAND_OVER_MOUTH = new UnicodeEmojiImpl("🤭");
	
	UnicodeEmoji FACE_WITH_OPEN_EYES_AND_HAND_OVER_MOUTH = new UnicodeEmojiImpl("🫢");
	
	UnicodeEmoji FACE_WITH_PEEKING_EYE = new UnicodeEmojiImpl("🫣");
