...
interface EmojiFamilyB {
	...
	UnicodeEmoji FAMILY_MWG = new UnicodeEmojiImpl("👨‍👩‍👧");
	
	UnicodeEmoji FAMILY_MWGB = new UnicodeEmojiImpl("👨‍👩‍👧‍👦");
	
	UnicodeEmoji FAMILY_MWBB = new UnicodeEmojiImpl("👨‍👩‍👦‍👦");
	
	UnicodeEmoji FAMILY_MWGG = new UnicodeEmojiImpl("👨‍👩‍👧‍👧");
	
	UnicodeEmoji FAMILY_MMB = new UnicodeEmojiImpl("👨‍👨‍👦");
	
	UnicodeEmoji FAMILY_MMG = new UnicodeEmojiImpl("👨‍👨‍👧");
	
	UnicodeEmoji FAMILY_MMGB = new UnicodeEmojiImpl("👨‍👨‍👧‍👦");
	
	UnicodeEmoji FAMILY_MMBB = new UnicodeEmojiImpl("👨‍👨‍👦‍👦");
	
	UnicodeEmoji FAMILY_MMGG = new UnicodeEmojiImpl("👨‍👨‍👧‍👧");
	
	UnicodeEmoji FAMILY_WWB = new UnicodeEmojiImpl("👩‍👩‍👦");
	
	UnicodeEmoji FAMILY_WWG = new UnicodeEmojiImpl("👩‍👩‍👧");
	
	UnicodeEmoji FAMILY_WWGB = new UnicodeEmojiImpl("👩‍👩‍👧‍👦");
	
	UnicodeEmoji FAMILY_WWBB = new UnicodeEmojiImpl("👩‍👩‍👦‍👦");
	
	UnicodeEmoji FAMILY_WWGG = new UnicodeEmojiImpl("👩‍👩‍👧‍👧");
