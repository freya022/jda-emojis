...
interface EmojiPlaceBuilding {
	...
	UnicodeEmoji WOOD = new UnicodeEmojiImpl("🪵");
	
	UnicodeEmoji HUT = new UnicodeEmojiImpl("🛖");
	
	UnicodeEmoji HOUSE_BUILDINGS = new UnicodeEmojiImpl("🏘️");
	...
	UnicodeEmoji DERELICT_HOUSE_BUILDING = new UnicodeEmojiImpl("🏚️");
	...
	UnicodeEmoji BANK = new UnicodeEmojiImpl("🏦");
	
	UnicodeEmoji HOTEL = new UnicodeEmojiImpl("🏨");
	
	UnicodeEmoji LOVE_HOTEL = new UnicodeEmojiImpl("🏩");
	
	UnicodeEmoji CONVENIENCE_STORE = new UnicodeEmojiImpl("🏪");
	
	UnicodeEmoji SCHOOL = new UnicodeEmojiImpl("🏫");
	
	UnicodeEmoji DEPARTMENT_STORE = new UnicodeEmojiImpl("🏬");
	
	UnicodeEmoji FACTORY = new UnicodeEmojiImpl("🏭");
	...
	UnicodeEmoji TOKYO_TOWER = new UnicodeEmojiImpl("🗼");
	
	UnicodeEmoji STATUE_OF_LIBERTY = new UnicodeEmojiImpl("🗽");
