...
interface EmojiAnimalMammal {
	UnicodeEmoji MONKEY_FACE = new UnicodeEmojiImpl("🐵");
	
	UnicodeEmoji MONKEY = new UnicodeEmojiImpl("🐒");
	
	UnicodeEmoji GORILLA = new UnicodeEmojiImpl("🦍");
	
	UnicodeEmoji ORANGUTAN = new UnicodeEmojiImpl("🦧");
	...
	UnicodeEmoji SERVICE_DOG = new UnicodeEmojiImpl("🐕‍🦺");
	
	UnicodeEmoji POODLE = new UnicodeEmojiImpl("🐩");
	...
	UnicodeEmoji CAT2 = new UnicodeEmojiImpl("🐈");
	
	UnicodeEmoji BLACK_CAT = new UnicodeEmojiImpl("🐈‍⬛");
	...
	UnicodeEmoji LEOPARD = new UnicodeEmojiImpl("🐆");
	...
	UnicodeEmoji ZEBRA = new UnicodeEmojiImpl("🦓");
	
	UnicodeEmoji DEER = new UnicodeEmojiImpl("🦌");
	
	UnicodeEmoji BISON = new UnicodeEmojiImpl("🦬");
	...
	UnicodeEmoji PIG2 = new UnicodeEmojiImpl("🐖");
	
	UnicodeEmoji BOAR = new UnicodeEmojiImpl("🐗");
	...
	UnicodeEmoji GOAT = new UnicodeEmojiImpl("🐐");
	
	UnicodeEmoji DROMEDARY_CAMEL = new UnicodeEmojiImpl("🐪");
	
	UnicodeEmoji CAMEL = new UnicodeEmojiImpl("🐫");
	
	UnicodeEmoji LLAMA = new UnicodeEmojiImpl("🦙");
	
	UnicodeEmoji GIRAFFE = new UnicodeEmojiImpl("🦒");
	
	UnicodeEmoji ELEPHANT = new UnicodeEmojiImpl("🐘");
	...
	UnicodeEmoji RABBIT2 = new UnicodeEmojiImpl("🐇");
	...
	UnicodeEmoji BAT = new UnicodeEmojiImpl("🦇");
	...
	UnicodeEmoji OTTER = new UnicodeEmojiImpl("🦦");
	
	UnicodeEmoji SKUNK = new UnicodeEmojiImpl("🦨");
