...
interface EmojiGame {
	...
	UnicodeEmoji DIRECT_HIT = new UnicodeEmojiImpl("🎯");
	...
	UnicodeEmoji PISTOL = new UnicodeEmojiImpl("🔫");
	
	UnicodeEmoji POOL_8_BALL = new UnicodeEmojiImpl("🎱");
	
	UnicodeEmoji CRYSTAL_BALL = new UnicodeEmojiImpl("🔮");
	
	UnicodeEmoji MAGIC_WAND = new UnicodeEmojiImpl("🪄");
	
	UnicodeEmoji VIDEO_GAME = new UnicodeEmojiImpl("🎮");
	...
	UnicodeEmoji PINATA = new UnicodeEmojiImpl("🪅");
