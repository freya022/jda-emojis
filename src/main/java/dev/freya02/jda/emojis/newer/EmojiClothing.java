...
interface EmojiClothing {
	...
	UnicodeEmoji SCARF = new UnicodeEmojiImpl("🧣");
	
	UnicodeEmoji GLOVES = new UnicodeEmojiImpl("🧤");
	
	UnicodeEmoji COAT = new UnicodeEmojiImpl("🧥");
	
	UnicodeEmoji SOCKS = new UnicodeEmojiImpl("🧦");
	
	UnicodeEmoji DRESS = new UnicodeEmojiImpl("👗");
	
	UnicodeEmoji KIMONO = new UnicodeEmojiImpl("👘");
	
	UnicodeEmoji SARI = new UnicodeEmojiImpl("🥻");
	
	UnicodeEmoji ONE_PIECE_SWIMSUIT = new UnicodeEmojiImpl("🩱");
	
	UnicodeEmoji BRIEFS = new UnicodeEmojiImpl("🩲");
	
	UnicodeEmoji SHORTS = new UnicodeEmojiImpl("🩳");
	...
	UnicodeEmoji PURSE = new UnicodeEmojiImpl("👛");
