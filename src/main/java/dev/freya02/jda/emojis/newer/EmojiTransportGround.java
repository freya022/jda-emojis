...
interface EmojiTransportGround {
	...
	UnicodeEmoji TRAIN2 = new UnicodeEmojiImpl("🚆");
	...
	UnicodeEmoji TRUCK = new UnicodeEmojiImpl("🚚");
	...
	UnicodeEmoji ROTATING_LIGHT = new UnicodeEmojiImpl("🚨");
	
	UnicodeEmoji TRAFFIC_LIGHT = new UnicodeEmojiImpl("🚥");
