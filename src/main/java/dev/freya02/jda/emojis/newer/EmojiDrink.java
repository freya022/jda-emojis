...
interface EmojiDrink {
	...
	UnicodeEmoji CLINKING_GLASS = new UnicodeEmojiImpl("🥂");
	
	UnicodeEmoji WHISKY = new UnicodeEmojiImpl("🥃");
	
	UnicodeEmoji TUMBLER_GLASS = new UnicodeEmojiImpl("🥃");
	
	UnicodeEmoji POURING_LIQUID = new UnicodeEmojiImpl("🫗");
	
	UnicodeEmoji CUP_WITH_STRAW = new UnicodeEmojiImpl("🥤");
	
	UnicodeEmoji BUBBLE_TEA = new UnicodeEmojiImpl("🧋");
	
	UnicodeEmoji BEVERAGE_BOX = new UnicodeEmojiImpl("🧃");
