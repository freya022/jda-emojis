...
interface EmojiBodyParts {
	...
	UnicodeEmoji MUSCLE_TONE3 = new UnicodeEmojiImpl("💪🏽");
	
	UnicodeEmoji MUSCLE_TONE4 = new UnicodeEmojiImpl("💪🏾");
	
	UnicodeEmoji MUSCLE_TONE5 = new UnicodeEmojiImpl("💪🏿");
	...
	UnicodeEmoji EAR_TONE1 = new UnicodeEmojiImpl("👂🏻");
	
	UnicodeEmoji EAR_TONE2 = new UnicodeEmojiImpl("👂🏼");
	
	UnicodeEmoji EAR_TONE3 = new UnicodeEmojiImpl("👂🏽");
	
	UnicodeEmoji EAR_TONE4 = new UnicodeEmojiImpl("👂🏾");
	
	UnicodeEmoji EAR_TONE5 = new UnicodeEmojiImpl("👂🏿");
	...
	UnicodeEmoji NOSE_TONE1 = new UnicodeEmojiImpl("👃🏻");
	
	UnicodeEmoji NOSE_TONE2 = new UnicodeEmojiImpl("👃🏼");
	
	UnicodeEmoji NOSE_TONE3 = new UnicodeEmojiImpl("👃🏽");
	
	UnicodeEmoji NOSE_TONE4 = new UnicodeEmojiImpl("👃🏾");
	
	UnicodeEmoji NOSE_TONE5 = new UnicodeEmojiImpl("👃🏿");
