...
interface EmojiTransportWater {
	UnicodeEmoji ANCHOR = new UnicodeEmojiImpl("⚓");
	
	UnicodeEmoji RING_BUOY = new UnicodeEmojiImpl("🛟");
	
	UnicodeEmoji SAILBOAT = new UnicodeEmojiImpl("⛵");
	
	UnicodeEmoji KAYAK = new UnicodeEmojiImpl("🛶");
	
	UnicodeEmoji CANOE = new UnicodeEmojiImpl("🛶");
